export const emailHTML = (token, username) => {
  return `<html>
  <head>
                    ...
                    <td align="center" bgcolor="#ffffff" style="padding: 12px">
                      <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          >
                            <a
                              href="http://localhost:6065/verify/${token}"
                              target="_blank"
                              style="
          ...
          >
            ...
            <tr>
              ...
              >
                <p style="margin: 0">
                  ...
                  register your account. If you didn't request
                  a registration you can safely delete this email.
                </p>
              </td>
            </tr>
            <!-- end permission -->
            ...
            <tr>
              ...
              >
                ...
                <p style="margin: 0">
                 Franziska Seitz, Berlin City, WebE09 2022
                </p>
              </td>
            </tr>
            <!-- end unsubscribe -->
